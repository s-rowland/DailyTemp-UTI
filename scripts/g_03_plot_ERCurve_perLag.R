...
# 2a Name function 
plot_ERCurve_perLag <- function(Sensitivity, SubSetVar, SubSet,
                                     ERConstraint, LRConstraint,ExpRange){
   #Sensitivity <- 'Main' ; SubSetVar <- 'FullSet'; SubSet <- 'FullSet' 
  #ERConstraint <- '3dfevenknots'; LRConstraint <- '2dfevenknots';ExpRange <- '0_100'
  ...
  # 2B.b Start the PDF
     pdf(here::here(outPath, 'plots', 
                    paste0('g03_allLags_', Sensitivity, '_', 
                    SubSetVar, '_', SubSet, '_', ExpRange, '.pdf')))
...
# 3a Main Models 
plot_ERCurve_perLag('Main', 'FullSet', 'FullSet', 'Selected', 'Selected', '5_95')
plot_ERCurve_perLag('Main', 'sex', 'f', 'Selected', 'Selected', '5_95')

plot_ERCurve_perLag('14DayLag', 'FullSet','FullSet', 'Selected', 'Selected', '0_100')
plot_ERCurve_perLag('14DayLag', 'FullSet', 'FullSet', 'Selected', 'Selected', '05_95')
plot_ERCurve_perLag('21DayLag', 'FullSet', 'FullSet', 'Selected', 'Selected', '0_100')

plot_ERCurve_perLag('oneLag', 'FullSet', 'FullSet', '3dfevenknots', 'oneLag', '0_100')
plot_ERCurve_perLag('noConstraint', 'FullSet', 'FullSet', '3dfevenknots', 'free', '0_100')
